...
(function () {
  ...
  style.textContent = `
    .ap-price-countdown{box-sizing:border-box;min-width:0;max-width:100%;display:flex;align-items:center;justify-content:space-between;gap:24px;margin:24px 0 32px;padding:22px 26px;border:1px solid #dedbd7;border-left:3px solid #ae392d;background:#fff;color:#252321;font:inherit;letter-spacing:0}
    ...
    .ap-price-countdown__clock{flex:0 1 280px;min-width:236px;max-width:100%}
    .ap-price-countdown__label{display:block;margin-bottom:8px;font-size:12px;line-height:1.5;color:#68635f}
    .ap-price-countdown__digits{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}
    .ap-price-countdown__unit{min-width:0;display:flex;flex-wrap:wrap;align-items:baseline;gap:3px;white-space:nowrap;font-size:11px;color:#68635f}
    ...
    .ap-price-countdown--detail{margin:18px 0 22px;padding:17px 16px;flex-wrap:wrap;gap:16px}
    ...
    @media(max-width:767px){.ap-price-countdown{align-items:stretch;flex-direction:column;gap:18px;padding:20px 17px;margin:20px 0 26px}.ap-price-countdown__title{font-size:18px!important}.ap-price-countdown__clock{flex-basis:auto;min-width:0;width:100%;max-width:300px}.ap-price-countdown__unit{flex-direction:column;align-items:flex-start;gap:2px}.ap-price-countdown__number{font-size:27px}.ap-price-countdown--detail{padding:16px;gap:13px}.ap-price-countdown--detail .ap-price-countdown__clock{min-width:0}}
  ...
  function mount() {
    ...
    root.setAttribute('data-ap-countdown', '2026-09-06b');
