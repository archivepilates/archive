(function () {
  ...
  menu.addEventListener('focusout', function (event) {
    // Safari blurs the summary to body before an unfocusable link receives its click.
    // Outside pointerdown already closes the menu; only close explicit focus moves here.
