(function () {
  ...
  function installStyle() {
    ...
    style.textContent = [
      ...
      ".ap-wish-card-host,.ap-wish-custom-shell{position:relative!important;min-width:0}",
      ".ap-wish-card-host>.ap-wish-button,.ap-wish-custom-shell>.ap-wish-button{position:absolute;top:10px;right:10px;z-index:12}",
      ".ap-wish-custom-shell>.ap-knitido-product-card{display:block;height:100%}",
