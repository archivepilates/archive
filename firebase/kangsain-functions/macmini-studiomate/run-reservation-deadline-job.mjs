...
try {
  const dryRun = await runWithRetry("dry-run", BROWSER_NODE, ["firebase/kangsain-functions/macmini-studiomate/set-reservation-deadline.mjs"], ROOT_DIR, {
    TZ: "Asia/Seoul",
    HEADLESS: "true",
    DRY_RUN: "true",
  });
  ...
  const realRun = await runWithRetry("save", BROWSER_NODE, ["firebase/kangsain-functions/macmini-studiomate/set-reservation-deadline.mjs"], ROOT_DIR, {
    TZ: "Asia/Seoul",
    HEADLESS: "true",
    DRY_RUN: "false",
    CONFIRM: "true",
