...
const checks = [
  ...
  ["scripts/lib/eformsign-refund-browser-contract.mjs", ["memberName: \"ozinput_24\"", "refundAmount: \"ozinput_32\"", "companySignature", "documentName", "documentId", "assertRefundJobStillWithinValidity", "assertRefundSourceUnchanged", "staleRefundJobRecoveryStatus", "extractEformsignDocumentId"]],
  ["scripts/process-eformsign-refund-jobs.mjs", ["if (config.loginOnly)", "authenticated = true", "recoverStaleJobs", "assertLiveRefundSource", "send_review_required", "acquireEformsignBrowserLock", "assertRefundJobStillWithinValidity", "eformsignDocumentId", "flexdatalist-userName", "inputOutsiderNumber", "EFORMSIGN_PROGRESS_DOCUMENTS_URL"]],
