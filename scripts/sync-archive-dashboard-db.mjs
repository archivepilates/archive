#!/usr/bin/env node
// Deprecated: this legacy script calculates dashboard sheets from raw Excel files.
// The active Mac mini runner now uses sync-archive-dashboard-db-export.mjs, which
// copies the Apps Script settlement export into Firestore without recalculation.
