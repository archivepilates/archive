...
grep -q "recommendedMealProgramForm" "$TMP_DIR/core.html"
grep -q "recommendedMealHistoryPanel" "$TMP_DIR/core.html"
grep -q "operatorSendRecommendedMealProgramAlimtalk" "$TMP_DIR/app.js"
...
grep -q "강사용 프라이빗 오늘 기록 안내 v4" "$TMP_DIR/rules.html"
