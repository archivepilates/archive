...
try {
  ...
  const screen = await page.evaluate(() => ({
    ...
    hasLegacyNotice: document.body.innerText.includes("운영자 앱 종료 안내"),
    hasCoreLink: document.body.innerText.includes("ARCHIVE CORE"),
  ...
  const failedScreen = !screen.hasLegacyNotice || !screen.hasCoreLink || screen.hasPermissionError || screen.hasInstructorTitle;
  const summary = {
