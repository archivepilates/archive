...
function buildBlocks() {
  ...
  return [
    ...
    bullet("장기 미방문 안내는 활성 수업 수강권 보유, 마지막 출석 10일 이상, 수강권 정지/중지/홀딩 아님, 발송 기준일 당일 또는 이후 예정 예약 없음 조건으로 후보를 만든다. 2026-05-26 기준 출석/정지 데이터 누락 감사가 끝날 때까지 11:30 자동 발송 대상에서는 임시 제외한다. 중복 방지는 회원별 14일이다."),
