...
| 목적 | 템플릿 ID | 기준 |
| --- | --- | --- |
| 스튜디오메이트 예약 안내 v4 | `KA01TP26072806273194229P2ZesQwPp` | 예약 오픈 안내 대상 |
...
| 프라이빗 사전설문 안내 v2 | `KA01TP260729144645970fv13He8mfsK` | 첫 프라이빗 등록/예약 회원, 자체 설문 링크 |
| 강사용 프라이빗 차트 작성 안내 v3 | `KA01TP260729144657202OV26yAD15wR` | 수업 전 계획·수업 후 기록·사진/영상 업로드 |
| 회원용 프라이빗 수업 리포트 안내 v1 | `KA01TP260528081225871Fr92FW901Vo` | 검수·승인된 회원 리포트 발송 |
| 장기 미방문 수업안내 v1 | `KA01TP260524083643752cySb9BoDOjN` | 활성 수업 수강권 보유, 마지막 출석 7일 이상, 수강권 정지/중지/홀딩 제외. 현재 `PENDING`이라 실제 발송 차단 |

구 수강권 기간/횟수/장기미방문 템플릿과 프라이빗 사전설문 v1·강사용 차트 v2는 신규 후보 생성에 연결하지 않는다. `long_absence`는 전용 템플릿과 데이터 연결은 완료했지만 승인 전까지 후보만 생성하고 실제 발송은 차단한다.
