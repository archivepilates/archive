...
그룹 기간권 잔여기간 안내 v3 `KA01TP260514145047261araXgWLVFRs`, 그룹 횟수권 잔여횟수 안내 v3 `KA01TP260514145047393VpTbcCZKkCV`, 프라이빗 기간권 잔여기간 안내 v1 `KA01TP260514153314927WH270IppWQS`, 프라이빗 횟수권 잔여횟수 안내 v1 `KA01TP260514152235608d9icGOBotnV`는 SOLAPI에 초안(`PENDING`)으로만 생성했다. 검수 요청 전 사용자가 문구를 수정할 수 있도록 자동 발송에는 연결하지 않는다.
